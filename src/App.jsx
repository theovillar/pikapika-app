...
const SILHOUETTES = {
  ...
  paris: (
    <g transform="translate(-58, -84) scale(2.6)" fill="currentColor" stroke="none">
    ...
    >
      ...
      <style>{`
        ...
        .oree-lieu-motif {
          ...
          width: min(520px, 92vw); pointer-events: none; z-index: 0;
          opacity: 0.18;
        }
        .oree-mode-nuit .oree-lieu-motif { opacity: 0.28; }
        @media (max-width: 700px) {
          .oree-lieu-motif { width: 82vw; bottom: 12vh; opacity: 0.16; }
        }
